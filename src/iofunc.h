...
extern HAMLIB_EXPORT(int) port_prepare_async(hamlib_port_t *p);
extern HAMLIB_EXPORT(void) port_cleanup_async(hamlib_port_t *p);
extern HAMLIB_EXPORT(int) port_async_is_prepared(const hamlib_port_t *p);
